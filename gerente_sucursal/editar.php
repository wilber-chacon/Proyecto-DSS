            ...
            if (isset($_GET['empleado'])) {
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="estado" id="estado" class="form-control">
                                <option value="<?php print($empleado->getestado()); ?>"><?php print($empleado->getestado()); ?>
                                </option>
                                </option>
                    ...
                    <input type="hidden" name="codigoempleado" id="codigoempleado"
                        value="<?php print($empleado->getcodigoE()); ?>">
                    <input type="hidden" name="codigosesion" id="codigosesion"
                        value="<?php print($empleado->getcodigosesion()); ?>">
                    <?php
            }
        } ?>
