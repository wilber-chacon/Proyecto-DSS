        ...
        if ($_GET) {
            if (isset($_GET['prestamo'])) {
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="#" data-toggle="modal" data-target="#AprobarModal"
                                class="btn btn-success mt-5  btn-sm btn-block" style="width: 100%; margin: auto;">Aprobar</a>
                        </div>
                        <div class="col">
                            <a href="#" data-toggle="modal" data-target="#RechazarModal"
                                class="btn btn-danger mt-5  btn-sm btn-block" style="width: 100%; margin: auto;">Rechazar</a>
                        </div>
                        <div class="col">
...
<div class="modal fade" id="AprobarModal" tabindex="-1" role="dialog" aria-labelledby="Aprobar"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="procesarAccion.php?operacion=aprobarPrestamo&id=<?php print($prestamo->getnumPrestamo()); ?>">Aceptar</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="RechazarModal" tabindex="-1" role="dialog" aria-labelledby="Rechazar"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="procesarAccion.php?operacion=rechazarPrestamo&id=<?php print($prestamo->getnumPrestamo()); ?>">Aceptar</a>
            </div>
        </div>
    </div>
</div>
